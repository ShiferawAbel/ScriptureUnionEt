        ...
        <div class="card w-50 mt-3">
            ...
            <form action="{{ route('admin.carousels.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="header" value="{{ old('header') }}" class="form-control" id="headline" placeholder="Enter the header of the carousel" autocomplete="off">
                  @error('header')
                      <p>{{$message}}</p>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="body" class="form-control" id="body" placeholder="Enter Body Here" autocomplete="off">
                  @error('body')
                      <p>{{$message}}</p>
                  @enderror
                </div>
