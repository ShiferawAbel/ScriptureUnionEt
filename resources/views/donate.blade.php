<x-layouts.app>
    ...
    @section('meta_canonical', $meta_data['canonical']) @section('meta_og_title', $meta_data['og_title'])
    @section('meta_og_description', $meta_data['og_description']) @section('meta_og_image',
    $meta_data['og_image']) @section('meta_og_url', $meta_data['og_url']) @section('meta_og_type',
    $meta_data['og_type']) @section('meta_twitter_card', $meta_data['twitter_card'])
    @section('meta_twitter_title', $meta_data['twitter_title']) @section('meta_twitter_description',
    $meta_data['twitter_description']) @section('meta_twitter_image', $meta_data['twitter_image'])
    ...
    <section class="donation">
        <div class="container">
            ...
            <p class="text-center">Your generosity will make a difference.</p>
            <div class="row">
                <div class="col-md-6">
                    <div class="donation-option">
                        <svg class="chapa" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 167 63"
                            xml:space="preserve" width="150">
                            <path fill="#8dc63f" opacity="0.59" enable-background="new" d="M11.8,26.2h23.5l0,0l0,0c0,3.6-2.9,6.5-6.5,6.5c0,0,0,0,0,0h-17c-1.8,0-3.3-1.5-3.3-3.3l0,0l0,0
                            C8.6,27.7,10,26.2,11.8,26.2L11.8,26.2L11.8,26.2z"></path>
                            <path fill="#8dc63f" opacity="0.59" enable-background="new"
                                d="M35.1,17.6l-4.7,6.5h6.2c3.6,0,6.5-2.9,6.5-6.5c0,0,0,0,0,0H35.1z"></path>
                            <path fill="#8dc63f" opacity="0.59" enable-background="new"
                                d="M22.4,24l4.6-6.4H11.9C16.3,17.6,20.4,20.1,22.4,24z"></path>
                            ...
                            <path fill="#7dc400" d="M116.1,31.9c0-1.8,0.5-3.5,1.5-4.9c1-1.5,2.3-2.7,3.9-3.5c2.8-1.5,6.2-1.7,9.2-0.6c1.3,0.5,2.4,1.2,3.4,2.1
                            ...
                            <path fill="#7dc400" d="M148.6,22.1c-5.4,0-9.8,4.4-9.8,9.8s4.4,9.8,9.8,9.8c2.1,0,4.1-0.7,5.8-1.9c1,1.2,2.4,1.9,4,1.9v-9.8
                            ...
                            <path fill="#7dc400" d="M104.4,22.1c-5.4,0-9.8,4.4-9.8,9.8c0,5.4,4.4,9.8,9.8,9.8c2.1,0,4.1-0.7,5.8-1.9c1,1.2,2.4,1.9,4,1.9v-9.8
                            ...
                            <path fill="#7dc400" d="M64.7,35.8c-3.9,0-7-3.2-7-7c0-3.9,3.2-7,7-7c1.9,0,3.6,0.8,4.9,2.1l4.1-4c-4.9-5-13-5.1-18-0.2s-5.1,13-0.2,18
                ...
                <div class="col-md-6">
                    <div class="donation-option">
                        ...
                        <button class="btn btn-filled btn-block" data-toggle="modal" data-target="#cbeModal">Donate with
                            CBE</button>
                    </div>
                </div>

                <!-- Modal -->
                <div class="modal fade" id="cbeModal" tabindex="-1" role="dialog" aria-labelledby="cbeModalLabel"
                    aria-hidden="true">
                ...
                <div class="col-md-6">
                    <div class="donation-option">
                        <img src="{{ asset('img/BankofAbyssiniaLogo.png') }}" style="width: 70%;margin-bottom: 45px;"
                            alt=">Abyssinia">
                        <p class="text-center">Donate using Abyssinia Bank. 166974828</p>
                        <button class="btn btn-filled btn-block" data-toggle="modal" data-target="#abyssinia">Donate
                            with Abyssinia Bank</button>
                    </div>
                </div>

                <!-- Modal -->
                <div class="modal fade" id="abyssinia" tabindex="-1" role="dialog" aria-labelledby="abyssiniaLabel"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <div class="col-md-6">
                    <div class="donation-option">
                        ...
                        <button class="btn btn-filled btn-block" data-toggle="modal" data-target="#berhan">Donate
                            with Berhan Bank</button>
                    </div>
                </div>

                <!-- Modal -->
                <div class="modal fade" id="berhan" tabindex="-1" role="dialog" aria-labelledby="berhanLabel"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <div class="col-md-6">
                    <div class="donation-option">
                        ...
                        <button class="btn btn-filled btn-block" data-toggle="modal" data-target="#dashen">Donate
                            with Dashen Bank</button>
                    </div>
                </div>

                <!-- Modal -->
                <div class="modal fade" id="dashen" tabindex="-1" role="dialog" aria-labelledby="dashenLabel"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
