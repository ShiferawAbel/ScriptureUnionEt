    ...
    <div class="container-fluid p-0">
        <div class="owl-carousel header-carousel position-relative mb-5">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/bible.jpg" alt="">
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                ...
                                <h1 class="display-3 text-white animated slideInDown mb-4">Goal-1 in short(eg Helping Encourage The Youth)</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">A short description about this goal </p>
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(6, 3, 21, .5);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Scripture Union Ethiopia</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Goal-2 in short</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">A short description about this goal </p>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Donate</a>
                                <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Join Us</a>
                            </div>
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="img/event-2.jpg" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(6, 3, 21, .5);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Scripture Union Ethiopia</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Goal-3 in short</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">A short description about this goal </p>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Donate</a>
                                <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Join Us</a>
                            </div>
